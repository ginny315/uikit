...
export const dbWorkflowDetails: Record<string, WorkflowDetail> = {
  wf_pr_review: {
    ...
    status: 'active',
    nodes: [
      { id: 'node_start', type: 'start', label: 'PR Opened', position: { x: 0, y: 0 } },
      { id: 'node_1', type: 'agent', label: 'code-reviewer', agentId: '1', position: { x: 0, y: 0 } },
      { id: 'node_2', type: 'agent', label: 'security-scanner', agentId: '2', position: { x: 0, y: 0 } },
      { id: 'node_3', type: 'agent', label: 'slack-notifier', agentId: '4', position: { x: 0, y: 0 } },
      { id: 'node_end', type: 'end', label: 'Done', position: { x: 0, y: 0 } },
    ],
    edges: [
  ...
  wf_incident: {
    ...
    status: 'active',
    nodes: [
      { id: 'node_start', type: 'start', label: 'Alert Fired', position: { x: 0, y: 0 } },
      { id: 'node_1', type: 'agent', label: 'incident-responder', agentId: '7', position: { x: 0, y: 0 } },
      { id: 'node_2', type: 'agent', label: 'log-analyzer', agentId: '13', position: { x: 0, y: 0 } },
      { id: 'node_end', type: 'end', label: 'Resolved', position: { x: 0, y: 0 } },
    ],
    edges: [
      { id: 'e_start_1', source: 'node_start', target: 'node_1' },
  ...
  wf_daily_report: {
    ...
    status: 'draft',
    nodes: [
      { id: 'node_start', type: 'start', label: 'Scheduled 9:00', position: { x: 0, y: 0 } },
      { id: 'node_1', type: 'agent', label: 'data-analyzer', agentId: '5', position: { x: 0, y: 0 } },
      { id: 'node_2', type: 'agent', label: 'cost-optimizer', agentId: '20', position: { x: 0, y: 0 } },
      { id: 'node_3', type: 'agent', label: 'doc-writer', agentId: '6', position: { x: 0, y: 0 } },
      { id: 'node_end', type: 'end', label: 'Published', position: { x: 0, y: 0 } },
    ],
    edges: [
      { id: 'e_start_1', source: 'node_start', target: 'node_1' },
      { id: 'e_start_2', source: 'node_start', target: 'node_2' },
  ...
  wf_data_pipeline: {
    ...
    status: 'active',
    nodes: [
      { id: 'node_start', type: 'start', label: 'Triggered', position: { x: 0, y: 0 } },
      { id: 'node_1', type: 'agent', label: 'log-analyzer', agentId: '13', position: { x: 0, y: 0 } },
      { id: 'node_2', type: 'agent', label: 'data-analyzer', agentId: '5', position: { x: 0, y: 0 } },
      { id: 'node_3', type: 'agent', label: 'schema-migrator', agentId: '16', position: { x: 0, y: 0 } },
      { id: 'node_end', type: 'end', label: 'Done', position: { x: 0, y: 0 } },
    ],
    edges: [
      { id: 'e_start_1', source: 'node_start', target: 'node_1' },
